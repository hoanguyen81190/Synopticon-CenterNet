...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--wamp', default='', action='store_true',
                             help='broadcast output ')
    
    self.parser.add_argument('--crossbar', default='127.0.0.1:8080',
                             help='set wamp crossbar address ')
    
    self.parser.add_argument('--realm', default='realm1',
                             help='set wamp realm ')
